...
//
Route::post('update-address/{updateId}', [App\Http\Controllers\Frontend\ProfileController::class, 'updateAddress'])->name('front.address.update');
Route::get('delete-address/{id}', [App\Http\Controllers\Frontend\ProfileController::class, 'deleteAddressAjax']);
Route::post('add-address', [App\Http\Controllers\Frontend\ProfileController::class, 'saveAddress'])->name('front.address.save');
...
Route::group(['prefix' => 'admin/', 'middleware' => 'auth'], function () {
    ...
    Route::middleware(['manager'])->group(function () {
        ...
        Route::get('warehousein_returndetail', [\App\Http\Controllers\WarehouseinController::class, 'warehouseinReturndetail'])->name('warehousein.returndetail');
        Route::get('warehousein_getProductListReturn', [\App\Http\Controllers\WarehouseinController::class, 'getProductListReturn'])->name('warehousein.getProductListReturn');
        Route::post('warehousein_returndetail', [\App\Http\Controllers\WarehouseinController::class, 'warehouseinReturndetailSave'])->name('warehousein.returndetail');
        Route::post('warehousein_updatereturndetail', [\App\Http\Controllers\WarehouseinController::class, 'updatereturndetail'])->name('warehousein.updatereturndetail');
        Route::post('warehousein_destroyreturndetail', [\App\Http\Controllers\WarehouseinController::class, 'destroyreturndetail'])->name('warehousein.destroyreturndetail');

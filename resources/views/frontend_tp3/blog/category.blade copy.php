    ...
    <aside class="news-sidebar">
        <div class="sidebar-section">
            ...
            <ul>
                ...
                <li><a href="#">Khoa học đời sống</a></li>
        ...
        <div class="sidebar-section">
            ...
            <ul class="highlighted-posts">
                <li><a href="#">Tiêu đề bài viết nổi bật 1</a></li>
                <li><a href="#">Tiêu đề bài viết nổi bật 2</a></li>
                <li><a href="#">Tiêu đề bài viết nổi bật 3</a></li>
            </ul>
        </div>
    </aside>
</div>

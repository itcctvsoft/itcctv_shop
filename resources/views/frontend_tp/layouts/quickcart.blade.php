...
<div class="offcanvas-body flex flex-col">
            ...
            <div class="flex flex-row">
                ...
                <div class="!w-full !ml-[1rem]">
                    <h3 class="post-title !text-[.8rem] !leading-[1.35] !mb-1"><a
                            href="{{ route('front.product.view', $procart->slug) }}"
                            class="title_color">{{ $procart->title }}</a></h3>
                    <p class="price !text-[.7rem]"> <ins class="no-underline text-[#e2626b]"><span
                                class="amount">{{ number_format($procart->price, 0, '.', ',') }}đ</span></ins> x
                        {{ $procart->quantity }}</p>
    ...
    <div class="offcanvas-footer flex-col text-center">
        ...
        <p class="!text-[.7rem] !mb-0">Liên hệ hotline: {{ $setting->hotline }} nếu gặp khó khăn trong quá trình mua
            hàng!</p>
    </div>
    <!-- /.offcanvas-footer-->
</div>

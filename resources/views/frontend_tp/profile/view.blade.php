    ...
    <section class="wrapper !bg-[#ffffff] py-[5rem] xl:!py-5 lg:!py-5 md:!py-5  ">
        <div class="container py-[0rem] xl:!py-0 lg:!py-0 md:!py-0">
            <div class="flex flex-wrap mx-[-15px] xl:mx-[-35px] lg:mx-[-20px]">
                <div
                    class="  xl:w-9/12 lg:w-9/12 md:w-0/12 w-full flex-[0_0_auto] xl:px-[10px] lg:px-[5px] px-[5px] max-w-full xl:order-2 lg:order-2">
                                            ...
                                            <div class="flex flex-wrap mx-[-10px]">
                                                <div
                                                    ...
                                                    <div class="form-floating relative !mb-4">
                                                        ...
                                                        <label for="form_name1"
                                                            class="text-[#959ca9] mb-2 inline-block text-[.75rem] absolute z-[2] h-full overflow-hidden text-start text-ellipsis whitespace-nowrap pointer-events-none border origin-[0_0] px-4 py-[0.6rem] border-solid border-transparent left-0 top-0 font-Manrope">Tên
                                                            đầy đủ *</label>
                                                ...
                                                <div
                                                    ...
                                                    <div class="form-floating relative !mb-4">
                                                        ...
                                                        <label for="form_name1"
                                                            class="text-[#959ca9] mb-2 inline-block text-[.75rem] absolute z-[2] h-full overflow-hidden text-start text-ellipsis whitespace-nowrap pointer-events-none border origin-[0_0] px-4 py-[0.6rem] border-solid border-transparent left-0 top-0 font-Manrope">Điện
                                                            thoại *</label>
                                                    ...
                                                    <div class="form-floating relative !mb-4">
                                                        ...
                                                        <label for="form_name1"
                                                            class="text-[#959ca9] mb-2 inline-block text-[.75rem] absolute z-[2] h-full overflow-hidden text-start text-ellipsis whitespace-nowrap pointer-events-none border origin-[0_0] px-4 py-[0.6rem] border-solid border-transparent left-0 top-0 font-Manrope">Địa
                                                            chỉ *</label>
                                                ...
                                                <div class="w-full flex-[0_0_auto] px-[15px] max-w-full">
                                                    <div class="form-floating relative !mb-4">
                                                        <input name="description" type="text"
                                                            value="{{ $profile->description }}" required
                                                            class=" form-control  relative block w-full text-[.75rem] font-medium text-[#60697b] bg-[#fefefe] bg-clip-padding border shadow-[0_0_1.25rem_rgba(30,34,40,0.04)] rounded-[0.4rem] border-solid border-[rgba(8,60,130,0.07)] transition-[border-color] duration-[0.15s] ease-in-out focus:text-[#60697b] focus:bg-[rgba(255,255,255,.03)] focus:shadow-[0_0_1.25rem_rgba(30,34,40,0.04),unset] focus:!border-[rgba(63,120,224,0.5)] focus-visible:!border-[rgba(63,120,224,0.5)] focus-visible:!outline-0 placeholder:text-[#959ca9] placeholder:opacity-100 m-0 !pr-9 p-[.6rem_1rem] h-[calc(2.5rem_+_2px)] min-h-[calc(2.5rem_+_2px)] leading-[1.25]"
                                                            placeholder="mô tả" required="">
                                                        <label for="form_name1"
                                                            class="text-[#959ca9] mb-2 inline-block text-[.75rem] absolute z-[2] h-full overflow-hidden text-start text-ellipsis whitespace-nowrap pointer-events-none border origin-[0_0] px-4 py-[0.6rem] border-solid border-transparent left-0 top-0 font-Manrope">Mô
                                                            tả *</label>
                ...
                <aside
                    class="  xl:w-3/12 lg:w-3/12 md:w-0/12 w-full flex-[0_0_auto] xl:px-[5px] lg:px-[5px] px-[5px] max-w-full sidebar mt-0 xl:!mt-0 lg:!mt-0">

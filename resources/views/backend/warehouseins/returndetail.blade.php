    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            products.forEach((pitem) => {
                ...
                newpro = new Product(pitem.id,pitem.title, pitem.price,pitem.type,0,pitem.quantity -pitem.qty_sold,imageurls[0],pitem.seri,pitem.series,plist);
...
$('#btnstore').on( "click", function() {
    ...
    $.ajax({
        url: "{{route('warehousein.returndetail',$warehousein->id)}}", // Replace with your actual server endpoint URL
        method: "POST",

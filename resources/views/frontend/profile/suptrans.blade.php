                            ...
                            <div class=" ">
                                <div class="row  ">
                                    ...
                                    <div class="col-lg-3  ">
                                        ...
                                        <a href="{{route('front.profile.paymentonline' )}}" class="btn btn-success  " style="color:white">Trả tiền công nợ</a>
                                ...
                                <div class="row  flex flex-col ">
                                    <div class='col-lg-9  '> 
                                        <form action="{{route('front.profile.viewsuptrans' )}}" method="get" id="filterForm" class="xl:flex sm:mr-auto">
                                            <!-- @csrf -->

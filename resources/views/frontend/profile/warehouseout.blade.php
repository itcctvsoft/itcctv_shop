                ...
                <div class="col-lg-9">
                    <div class="faq-content tab-content" id="top-tabContent">
                        ...
                        <div class="report-table">
                            ...
                            ?>
                            <div class="report-row"  onclick="toggleDetails({{$order->id}})">
                                <div class="report-cell"> {{$order->created_at}}</div>
                                <div class="report-cell"> {{$order->final_amount}}</div>
                                <div class="report-cell {{$classname}}"> {{$order->status}} </div>
                            </div>
                               <!-- Chi tiết phiếu (ẩn mặc định) -->
                            <div id="details-{{$order->id}}" class="report-details hidden">
                        ...
                        <div class="intro-y col-span-12 flex flex-wrap sm:flex-row sm:flex-nowrap items-center">
                          <nav class="w-full sm:w-auto sm:mr-auto">
                              {{$wouts->links('vendor.pagination.tailwind')}}
                          </nav>
                        </div>
                    </div>
                </div>

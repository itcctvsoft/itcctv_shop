                    ...
                    <div class="col-span-12 lg:col-span-4">
                        <div class="intro-y box mt-3  py-3 px-3 ">
                            <div class="mt-3">
                                ...
                                <select id="warehouse_id" name="wh_id" class="form-select mt-2 sm:mr-2"    >
                                    <?php $__currentLoopData = $warehouses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wh): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($wh->id); ?>" <?php echo e($order->wh_id==$wh->id?'selected':''); ?>><?php echo e($wh->title); ?></option>
                            ...
                            <div class=" mt-3 ">
                                ...
                                value="<?php echo e(\App\Models\User::where('id',$order->customer_id)->value('full_name')); ?>"
                                class="form-control py-3  mt-2" placeholder="Tên hoặc số điện thoại">
                                <input type="hidden" id="customer_id" value="<?php echo e($order->customer_id); ?>" />
                        ...
                        <div class="intro-y box mt-3  py-3 px-3">
                            ...
                            <div class="mt-3"> 
                                ...
                                <input type="number" id='discount_amount'  value="<?php echo e($order->discount_amount); ?>"
                            ...
                            <div class="mt-3">
                                <div class="mt-2">
                                    <div class="form-check form-switch"> 
                                        <input style="display:none" id="check_paidall" <?php echo e($order->is_paid == true?'checked':''); ?> class="form-check-input" type="checkbox"> <label class="form-check-label" for="checkbox-switch-7">Đã thanh toán hết</label> </div>
                                </div>
                                <input  id='paid_amount' type="hidden" name='paid_amount' 
                                value="<?php echo e($order->paid_amount); ?>"
...
$(document).ready(function(){ //Your code here 
    $.ajax({
        type: 'GET',
        url: '<?php echo e(route("order.getProductList")); ?>',
        data: {
            wo_id: <?php echo e($order->id); ?>,
...
$('#btnstore').on( "click", function() {
    ...
    importDoc = new ImportDoc(<?php echo e($order->id); ?>,customer_id,final_amount,discount_amount,shipcost,paid_amount,bank_id,wh_id,delivery_id);
    ...
    $.ajax({
        url: "<?php echo e(route('order.update',$order->id)); ?>", // Replace with your actual server endpoint URL
        method: "POST",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Workspace\KhoaLuan_2024\shop-main\resources\views/backend/orders/edit.blade.php ENDPATH**/ ?>
                                    ...
                                    <div >
                                        <div class="text-base text-slate-500">Khách hàng</div>
                                            <div class="text-lg font-medium text-primary mt-2">
                                                <?php echo e(\App\Models\User::where('id',$order->customer_id)->value('full_name')); ?>

                                            </div>
                                            <div class="mt-1"><?php echo e(\App\Models\User::where('id',$order->customer_id)->value('phone')); ?></div>
                                            <div class="mt-1"><?php echo e(\App\Models\User::where('id',$order->customer_id)->value('address')); ?></div>
                                        </div>
                                    </td>
                                    <td class="text-right">
                                    <div  >
                                        ...
                                        <div class="text-lg font-medium text-primary mt-2">
                                        <?php echo e(\App\Models\Warehouse::where('id',$order->wh_id)->value('title')); ?>
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Workspace\KhoaLuan_2024\shop-main\resources\views/backend/orders/show.blade.php ENDPATH**/ ?>
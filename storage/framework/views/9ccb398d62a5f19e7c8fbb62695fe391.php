      ...
      <div class="grid grid-cols-12 gap-12 mt-5">
        <div class="intro-y col-span-12 lg:col-span-12">
          ...
          <div class="intro-y col-span-12 flex flex-col sm:flex-row sm:items-end xl:items-start">
            <form action="<?php echo e(route('user.showsup', $user->id)); ?>" method="get" id="filterForm" class="xl:flex sm:mr-auto">
                <!-- <?php echo csrf_field(); ?> -->
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\itcctv_shop\resources\views/backend/suptrans/show.blade.php ENDPATH**/ ?>
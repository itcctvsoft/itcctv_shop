                    ...
                    <div class="mt-3">
                        <div class="flex flex-col sm:flex-row items-center">
                            ...
                            <select name="condition"  class="form-select mt-2 sm:mr-2"   >
                                ...
                                <option value ="banner" <?php echo e(old('condition')=='banner'?'selected':''); ?>>Banner</option>
                                <option value = "promo" <?php echo e(old('condition')=='promo'?'selected':''); ?>>Promo</option>
                                <option value = "ads" <?php echo e(old('condition')=='ads'?'selected':''); ?>>Ads</option>
                                <option value = "modpro" <?php echo e(old('condition')=='modpro'?'selected':''); ?>>modpro</option>
                            </select>
                        </div>
                    </div>
                    <div class="mt-3">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shoplite\resources\views/backend/banners/create.blade.php ENDPATH**/ ?>
                            ...
                            <div class="mt-3">
                                ...
                                <select id="delivery_id" name="delivery_id" class="form-select mt-2 sm:mr-2"    >
                                    ...
                                    <?php $__currentLoopData = $deliveries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $delivery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($delivery->id); ?>"  ><?php echo e($delivery->full_name); ?></option>
...
$('#btnstore').on( "click", function() {
    ...
    $.ajax({
        url: "<?php echo e(route('order.outupdate')); ?>", // Replace with your actual server endpoint URL
        method: "POST",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\itcctv_shop\resources\views/backend/orders/orderout.blade.php ENDPATH**/ ?>
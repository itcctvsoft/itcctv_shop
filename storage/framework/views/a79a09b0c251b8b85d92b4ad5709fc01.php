                                ...
                                <div class="dropdown-menu w-40"> 
                                    <ul class="dropdown-content">
                                        ...
                                        <?php if($item->status == 'returned'): ?>
                                            ...
                                            <li> 
                                                <form action="<?php echo e(route('warehousein.destroyreturndetail',$item->id)); ?>" method = "post">
                                                <?php echo csrf_field(); ?>
                                        ...
                                        <?php if($item->status == 'active'): ?>
                                            ...
                                            <li> 
                                                <form action="<?php echo e(route('warehousein.returndetail')); ?>" method = "get">
                                                <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\itcctv_shop\resources\views/backend/warehouseins/index.blade.php ENDPATH**/ ?>
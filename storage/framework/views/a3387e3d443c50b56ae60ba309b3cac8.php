            ...
            <div class="w-full sm:w-auto mt-3 sm:mt-0 sm:ml-auto md:ml-0">
                <div class="w-56 relative text-slate-500">
                    <form action="<?php echo e(route('supplier.search')); ?>" method = "get">
                        ...
                        <input type="text" value = "<?php echo e(isset($searchdata)?$searchdata:''); ?>" name="datasearch" class="ipsearch form-control w-56 box pr-10" placeholder="Search...">
                    ...
                    <tr class="intro-x">
                        ...
                        <td class="table-report__action w-56">
                            ...
                            <div class="dropdown py-3 px-1 ">  
                                ...
                                <div class="dropdown-menu w-40"> 
                                    <ul class="dropdown-content">
                                        <li><a class="dropdown-item" href="<?php echo e(route('user.showsup',$item->id)); ?>" class="flex items-center mr-3" href="javascript:;"> <i data-lucide="eye" class="w-4 h-4 mr-1"></i> Xem công nợ </a></li>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\itcctv_shop\resources\views/backend/suppliers/index.blade.php ENDPATH**/ ?>
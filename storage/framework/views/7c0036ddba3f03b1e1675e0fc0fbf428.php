...
<?php echo $__env->make('backend.layouts.notification', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <a href="<?php echo e(route('warehouse.create')); ?>" class="btn btn-primary shadow-md mr-2">Thêm kho</a>
            
            <div class="hidden md:block mx-auto text-slate-500">Hiển thị trang <?php echo e($warehouses->currentPage()); ?> trong <?php echo e($warehouses->lastPage()); ?> trang</div>
            <div class="w-full sm:w-auto mt-3 sm:mt-0 sm:ml-auto md:ml-0">
                <div class="w-56 relative text-slate-500">
                    <form action="<?php echo e(route('warehouse.search')); ?>" method = "get">
                        <?php echo csrf_field(); ?>
                    ...
                    <tr class="intro-x">
                        ...
                        <td class="table-report__action w-56">
                            <div class="flex justify-center items-center">
                                <a href="<?php echo e(route('warehouse.edit',$item->id)); ?>" class="flex items-center mr-3" href="javascript:;"> <i data-lucide="check-square" class="w-4 h-4 mr-1"></i> Edit </a>
                                <form action="<?php echo e(route('warehouse.destroy',$item->id)); ?>" method = "post">
                                    <?php echo csrf_field(); ?>
    ...
    <!-- END: HTML Table Data -->
        ...
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-row sm:flex-nowrap items-center">
            <nav class="w-full sm:w-auto sm:mr-auto">
                <?php echo e($warehouses->links('vendor.pagination.tailwind')); ?>
...
<script>
    ...
    $("[name='toogle']").change(function() {
        ...
        var id=$(this).val();
        $.ajax({
            url:"<?php echo e(route('warehouse.status')); ?>",
            type:"post",
            data:{
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\itcctv_shop\resources\views/backend/warehouses/index.blade.php ENDPATH**/ ?>
...
<div class="content">
    ...
    <div   class=" intro-y col-span-12 flex flex-col sm:flex-row sm:items-end xl:items-start">
                    <form action="<?php echo e(route('report.congnosup')); ?>" method = "get" class="xl:flex sm:mr-auto" >
                        <!-- <?php echo csrf_field(); ?> -->
                        <div class="sm:flex items-center sm:mr-4">
                            ...
                            <select name="order_name" id="tabulator-html-filter-field" class="form-select w-full sm:w-32 2xl:w-full mt-2 sm:mt-0 sm:w-auto">
                                ...
                                <option value="tongdt" <?php echo e($order_name == "tongdt"?"selected":""); ?>>&nbsp;&nbsp; Doanh thu &nbsp;&nbsp;</option>
                                <option value="tongln" <?php echo e($order_name == "tongln"?"selected":""); ?>>&nbsp;&nbsp; Lợi nhuận &nbsp;&nbsp;</option>
                ...
                <div id="divprint" class="intro-y box overflow-hidden mt-5">
                    <div class="border-b border-slate-200/60 dark:border-darkmode-400 text-center sm:text-left">
                        <div class="px-5 py-10 sm:px-20 sm:py-10">
                            ...
                            ?>
                            <h2 class="font-medium"> Tổng công nợ cần trả: <?php echo e(number_format($tong,0,".",",")); ?> </h2>
                                ...
                                <table id="myTable" class="display table" style="width:100%">
                                    ...
                                    <?php if($debt->id != null): ?>
                                        <tr>
                                            ...
                                            <td > <?php echo e(number_format($debt->tongnhap,0,".",",")); ?> </td>
                                            <td class ="<?php echo e($debt->tongln < 0? 'text-danger':''); ?>"> <?php echo e(number_format($debt->tongban,0,".",",")); ?> </td>
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\shop\resources\views/backend/reports/congnosup.blade.php ENDPATH**/ ?>
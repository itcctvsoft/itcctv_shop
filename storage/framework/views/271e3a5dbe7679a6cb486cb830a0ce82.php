...
<?php echo $__env->make('backend.layouts.notification', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <div class="grid grid-cols-12 gap-12 mt-5">
        <div class="intro-y col-span-12 lg:col-span-12">
            <!-- BEGIN: Form Layout -->
            <form method="post" action="<?php echo e(route('propertytodestroy.store')); ?>">
                <?php echo csrf_field(); ?>
...
$(document).ready(function(){ //Your code here 
    ...
    product_search.autocomplete({
        source: function(request, response) {
            ...
            $.ajax({
                type: 'GET',
                url: '<?php echo e(route('product.jsearchptw')); ?>',
                data: {
                    data: request.term,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\shop\resources\views/backend/propertytodestroys/create.blade.php ENDPATH**/ ?>
                    ...
                    <div  class="" >
                        ...
                        <div style=" width: 100%; margin: 0 auto; font-family: Arial, sans-serif; background-color: #f9f9f9; padding: 20px; border-radius: 10px; ">
                         ...
                         <div   class="option1">
                             ...
                             <div  >
                                 ...
                                 <div style="border: 1px solid #ddd; padding: 10px; display: inline-block; border-radius: 10px;">
                                     <img src="https://qr.sepay.vn/img?acc=<?php echo e(env('SEPAY_BANKNUM')); ?>&bank=<?php echo e(env('SEPAY_BANKNAME')); ?>&amount=<?php echo e($order->price); ?>&des=<?php echo e($order->code); ?>&template=compact&download=true" alt="QR Code" style="width: 200px; height: 200px;">
                                 </div>
                             ...
                             <div class="option2" >
                                 ...
                                 <table style="width: 100%; border-collapse: collapse;">
                                     <tr>
                                         ...
                                         <td style="padding: 5px 0;"><?php echo e(env('SEPAY_BANKNAME')); ?></td>
                                     </tr>
                                     <tr>
                                         <td style="padding: 5px 0; font-weight: bold;">Thụ hưởng:</td>
                                         <td style="padding: 5px 0;"><?php echo e(env('SEPAY_BANKACCOUNT')); ?></td>
                                     </tr>
                                     <tr>
                                         <td style="padding: 5px 0; font-weight: bold;">Số tài khoản:</td>
                                         <td style="padding: 5px 0;"><?php echo e(env('SEPAY_BANKNUM')); ?></td>
                                     </tr>
                                     <tr>
                         ...
                         <p id ='success_pay_box' style="display:none; text-align: center; margin-top: 20px; font-size: 14px; color: #666;">
                            Trạng thái: <span style="color:green;">Đã thanh toán thành công!Hãy đến <a href="<?php echo e(route('front.profile.viewsuptrans')); ?>">Xem công nợ </span>  
                        </p>
                    </div>
                       <!-- Form Thanh Toán -->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\itcctv_shop\resources\views/frontend/profile/online_paymentuser.blade.php ENDPATH**/ ?>
                ...
                <div id="divprint" class="intro-y box overflow-hidden  px-10">
                    <div class="border-b border-slate-200/60 dark:border-darkmode-400 text-center sm:text-left">
                        <div class="px-1 py-5 sm:px-1 sm:py-2">
                            ...
                            <div style="text-align:center" class="mt-1 text-xl"> Số: <?php echo e($warehouseout->code); ?></div>
                            ...
                            <table class="table" style="margin-bottom:10px">
                                ...
                                <tfooter>
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding:2px !important; padding-top:6px !important; padding-bottom:6px !important; "  class="text-right  " colspan="2">
                                            <?php echo e(number_format($paid_amount, 0, '.', ',')); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding:2px !important; padding-top:6px !important; padding-bottom:6px !important; "  class="text-right text-danger " colspan="4">
                                            <br/>
                                            <?php echo e(number_format(($sum_return ), 0, '.', ',')); ?>

                                          
                                        </td>
                                    </tr>
                                    <?php $__currentLoopData = $return_wos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $return_wo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                        ...
                                        <td   style="padding:2px !important; padding-top:6px !important; padding-bottom:6px !important; "  colspan='3'  class="text-left ">
                                            HOÁ ĐƠN <a style="font-weight:700" href="<?php echo e(route('warehouseout.show',$return_wo->id)); ?>"><?php echo e($return_wo->code); ?> </a> 
                                        </td>
                                        <td style="padding:2px !important; padding-top:6px !important; padding-bottom:6px !important; "  class="text-left "> ngày <?php echo e($formatted_date); ?> </td>
                                        ...
                                        <?php
                                            $i = 1;
                                        ?>
                                        <?php $__currentLoopData = $return_wo->details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td style="padding:2px !important; padding-top:6px !important; padding-bottom:6px !important; "> 
                                                <?php echo $i; $i ++; ?>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding:2px !important; padding-top:6px !important; padding-bottom:6px !important; "  class="text-right font-medium">
                                                <?php echo e(number_format($return_wo->final_amount,0,',','.')); ?>
                            ...
                            <tr>
                                ...
                                <td class='align-top'>
                                    <div class="text-center sm:text-right sm:ml-auto" >
                                        ...
                                        <div style=" left:0px; border: 0px  ; padding: 0px; display: inline-block;  ">
                                            <img src="https://qr.sepay.vn/img?acc=<?php echo e($defaultbank->banknumber); ?>&bank=<?php echo e($defaultbank->bankname); ?>&amount=<?php echo e($warehouseout->final_amount); ?>&des=<?php echo e($warehouseout->code); ?>&template=compact&download=true" 
                                ...
                                <td class='align-top'>
                                    <div class="text-center sm:text-right sm:ml-auto" >
                                        ...
                                        <?php if($order && $defaultbank): ?>
                                        <div style=" left:0px; border: 0px  ; padding: 0px; display: inline-block;  ">
                                            <img src="https://qr.sepay.vn/img?acc=<?php echo e($defaultbank->banknumber); ?>&bank=<?php echo e($defaultbank->bankname); ?>&amount=<?php echo e($order->price); ?>&des=<?php echo e($order->code); ?>&template=compact&download=true" 
                                            alt="QR Code" style="width: 120px; height: auto;">
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\itcctv_shop\resources\views/backend/warehouseouts/show.blade.php ENDPATH**/ ?>
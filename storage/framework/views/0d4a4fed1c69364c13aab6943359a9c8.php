                    ...
                    <div class="col-span-12 2xl:col-span-3">
                                ...
                                <div class="mt-5 relative before:block before:absolute before:w-px before:h-[85%] before:bg-slate-200 before:dark:bg-darkmode-400 before:ml-5 before:mt-5">
                                     ...
                                     <?php
                                                    ...
                                                    if(strcmp($log->doc_type,  "wi") == 0||strcmp($log->doc_type,  "wir") == 0)
                                                    {
                                                    ...
                                                    if(strcmp($log->doc_type,  "wo") == 0 || strcmp($log->doc_type,  "wor") == 0)
                                                    {
                                                        $classname="text-success";
                                                    ...
                                                    if(strcmp($log->doc_type,  "bedit") == 0)
                                                    {
                                                        $classname="text-warning";
                                                        $url =  "";
                                                    ...
                                                    if(strcmp($log->doc_type,  "co") == 0  )
                                                    {
                                                        // $classname="text-warning";
                                                      
                                                        $item = \App\Models\ComboCreation::find($log->doc_id) ;
                                                        $url =  route('combocreation.show' ,$log->doc_id);
                                                        if($item)
                                                            $total = $item->quantity*$item->price;
                                                        else
                                                            $total = 0;
                                                    }
                                                    if(strcmp($log->doc_type,  "ic") == 0  )
                                                    {
                                                        $item = \App\Models\InventoryCheck::find($log->doc_id) ;
                                                        $url =  route('inventorycheck.show' ,$log->doc_id);
                                                        if($item)
                                                            $total = $item->total;
                                                        else
                                                            $total = 0;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Workspace\KhoaLuan_2024\shop-main\resources\views/backend/index.blade.php ENDPATH**/ ?>
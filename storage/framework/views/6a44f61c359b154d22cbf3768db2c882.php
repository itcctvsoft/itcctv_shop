                    ...
                    <tr class="intro-x ">
                        <td>
                           ...
                           <a  href="<?php echo e(route('order.show',$item->id)); ?>"> 
                            <?php echo e($item->code!= ''?$item->code : $item->id); ?>
                        ...
                        <td >
                         <span class="<?php echo e($class_p); ?>">   <?php echo e($item->status); ?> </span>
                        </td>
                        <td>
                            ...
                            <div class="dropdown py-3 px-1 ">  
                                ...
                                <div class="dropdown-menu w-40"> 
                                    <ul class="dropdown-content">
                                        ...
                                        <?php if($item->status == 'pending' || $item->status == 'Paid'): ?>
                                            ...
                                            <li> 
                                                <form action="<?php echo e(route('order.thanhtoan',$item->id)); ?>" method = "post">
                                                <?php echo csrf_field(); ?>
                                                
                                                <a class="dropdown-item flex items-center text-success paymentbtn" data-id="<?php echo e($item->id); ?>" href="javascript:;"    > <i data-lucide="aperture" class="w-4 h-4 mr-1"></i>Thanh toán online</a>
                                                </form>
                                            </li>
                                            <li> 
                                                ...
                                                <a class="dropdown-item flex items-center text-danger dltBtn" data-id="<?php echo e($item->id); ?>" href="javascript:;"   > <i data-lucide="trash-2" class="w-4 h-4 mr-1"></i> Delete </a>
                                                </form>
                                            </li>
                                        <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\itcctv_shop\resources\views/backend/orders/index.blade.php ENDPATH**/ ?>
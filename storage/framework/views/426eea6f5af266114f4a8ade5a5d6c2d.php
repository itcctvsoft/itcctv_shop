...
<?php echo $__env->make('backend.layouts.notification', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <div class="mt-3">
        <form action="<?php echo e(route('setting.updateversion12')); ?>" method = "post">
         <?php echo csrf_field(); ?>
        <button type="submit" class ="btn">Cập nhật phiên bản từ 1 lên 2</button>
        </form>
    </div>
    <div class="mt-3">
        <form action="<?php echo e(route('setting.generatekey')); ?>" method = "post">
         <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\itcctv_shop\resources\views/backend/setting/updatedata.blade.php ENDPATH**/ ?>
            ...
            <div class="w-full sm:w-auto mt-3 sm:mt-0 sm:ml-auto md:ml-0">
                <div class="w-56 relative text-slate-500">
                    <form action="<?php echo e(route('product.search')); ?>" method = "get">
                        <?php echo csrf_field(); ?>
                        <input type="text" name="datasearch" value="<?php echo e($searchdata); ?>" class="ipsearch form-control w-56 box pr-10" placeholder="Search...">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\itcctv_shop\resources\views/backend/products/search.blade.php ENDPATH**/ ?>